            ...
            <div class="content">
                <?php if ($active_tab === "1") {
                    ...
                    If you encounter any issues, please request free support before leaving a negative review, as various factors such as low WordPress memory and other considerations may be at play. Check out our Troubleshooting tab.
                     <br>
                    <a href="https://siterightaway.net/troubleshooting-for-non-wordpress/" target="_blank" class="button button-primary">Troubleshooting Page</a>

                    <br>
                    <a href="https://www.billminozzi.com/dove/" target="_blank" class="button button-primary">Support Page</a>
