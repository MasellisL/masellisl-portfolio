<?php namespace hide_site_title_BillDiagnose;
...
class hide_site_title_Bill_Diagnose
{
...
// >>>>>>>>>>>>>>>>>>>
    ...
    */
    ...
    {
        $last_notification_date = get_option("hide_site_title_bill_show_warnings");
        $today = date("Y-m-d");
    ...
    {
        if(!function_exists('hide_site_title_bill_strip_strong99'))
        {
            function hide_site_title_bill_strip_strong99($htmlString)
            {
                // return $htmlString;
                                    ...
                                    if ($is_javascript) {
                                        ...
                                        if (preg_match($pattern, $line, $matches)) {
                                            ...
                                            $log_entry = [
                                                "Date" => $filteredDate ,
                                                "News Type" => $matches[1],
                                                "Problem Description" => hide_site_title_bill_strip_strong99(
                                                    $matches[2]
                                                ),
                                            ];
...
*/
$diagnose_instance = hide_site_title_Bill_Diagnose::get_instance(
    $notification_url,
    $notification_url2,
);
update_option("hide_site_title_bill_show_warnings", date("Y-m-d"));